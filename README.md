...
- [mbolli/php-geobuf](https://github.com/mbolli/php-geobuf) — PHP library for the geobuf compact geospatial format. (5 days ago)
...
- [mbolli/php-geobuf](https://github.com/mbolli/php-geobuf) ([v0.3.0](https://github.com/mbolli/php-geobuf/releases/tag/v0.3.0), 5 days ago) - PHP library for the geobuf compact geospatial format.
- [mbolli/php-via](https://github.com/mbolli/php-via) ([v0.5.0](https://github.com/mbolli/php-via/releases/tag/v0.5.0), 6 days ago) - Real-time engine for building reactive web applications in PHP with Swoole.
...
- [cosmiciron/vmprint](https://github.com/cosmiciron/vmprint) - An alternative to React-PDF — render multi-page documents anywhere. Preview on canvas and export to PDF/SVG from the same layout — no PDF.js, no React, no server. Pure JS, no dependencies. ~1.7MB. https://cosmiciron.github.io/vmprint/examples/preview/ (3 weeks ago)
