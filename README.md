...
- [fastserial/lite3](https://github.com/fastserial/lite3) - A JSON-Compatible Zero-Copy Serialization Format (6 days ago)
- [parsedown/parsedown](https://github.com/parsedown/parsedown) - Better Markdown Parser in PHP (3 weeks ago)
