...
- [mbolli/php-via](https://github.com/mbolli/php-via) ([v0.1.0](https://github.com/mbolli/php-via/releases/tag/v0.1.0), 4 days ago) - Real-time engine for building reactive web applications in PHP with Swoole.
...
- [starfederation/datastar](https://github.com/starfederation/datastar) ([v1.0.0-RC.7](https://github.com/starfederation/datastar/releases/tag/v1.0.0-RC.7), 1 week ago) - The hypermedia framework.
...
- [fastserial/lite3](https://github.com/fastserial/lite3) - A JSON-Compatible Zero-Copy Serialization Format (3 days ago)
- [parsedown/parsedown](https://github.com/parsedown/parsedown) - Better Markdown Parser in PHP (2 weeks ago)
