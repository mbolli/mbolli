...
- [fastserial/lite3](https://github.com/fastserial/lite3) - A JSON-Compatible Zero-Copy Serialization Format (1 week ago)
- [parsedown/parsedown](https://github.com/parsedown/parsedown) - Better Markdown Parser in PHP (4 weeks ago)
